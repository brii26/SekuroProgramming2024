...
public:
    void calculateVelocities() {
        ...
        //time loop increment 0.01 to 6.3
        for (double t = 0.01; t <= 6.3; t += 0.01) {
            ...
            // Calculate v1x, v1y, v2x, v2y, v3x, v3y, v4x, v4y 
            ...
            // Calculate v1, v2, v3, v4 using the formula v^2 = vx^2 + vy^2
